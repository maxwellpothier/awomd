...
/**
 * The components gallery — every block, with sample data, in its web form.
 *
 ...
 *
 * The email counterpart is the email render of any issue, which is a whole
 * document rather than a grid, so the two are checked side by side rather
 * than merged into one page.
 */
export default function ComponentsGallery() {
  ...
  const map = createWebComponents({ issue: "gallery" }) as Record<
    string,
    Block
  >;
